...
public class ProducerConfig extends ZKConfig implements SyncProducerConfigShared, AsyncProducerConfigShared {
     ...
     * {@link CompressionCodec#NoCompressionCodec}
     * 
    ...
    /**
     * This parameter allows you to set whether compression should be
     ...
     * time period, it could end up picking a broker partition that is
     * unavailable. When this happens, the ZK cache needs to be updated.
